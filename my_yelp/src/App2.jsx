    ...
    return (
        <>
            <Navbar expand="lg" variant="light" bg="light">
                <Container>
                    <Navbar.Brand href="#">Qwasar Restaurants</Navbar.Brand>
                    <Heading level={4}>Hello {user.username}</Heading>
                    <Button variant="warning">Log out</Button>{' '}
                </Container>
            </Navbar>

            <Container style={{ width: 400, margin: '0 auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 20 }}>
                <input
...
const styles = {
    ...
    input: { border: 'none', backgroundColor: '#f8d7d7', marginBottom: 10, borderRadius: "12px", padding: 8, fontSize: 18 },
    todoName: { fontWeight: 'bold', fontSize: 20 },
    todoDescription: { marginBottom: 0 },
    button: { backgroundColor: "#6d816d", color: 'black', outline: 'none', fontSize: 18, padding: '12px 0px', borderRadius: "12px" }
}
